#ifndef OPEN_DL_METU_FEATURE_SIFT_DESCRIPTOR_EXTRACTOR_HPP
#define OPEN_DL_METU_FEATURE_SIFT_DESCRIPTOR_EXTRACTOR_HPP

extern "C" {
	#include <Open_DL_METU/nonFree/vlfeat/vl/sift.h>
}
...
#include "Open_DL_METU/feature/sift_parameters.hpp"
