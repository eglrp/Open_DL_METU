#ifndef OPEN_DL_METU_FEATURE_KEYPOINT_HPP
#define OPEN_DL_METU_FEATURE_KEYPOINT_HPP
...
#define OPEN_DL_METU_INVALID_KEYPOINT_VAR -9999
	...
	public:
		...
		Keypoint(double x, double y, KeypointType type)
			: x_(x), y_(y), keypoint_type_(type),
		        strength_(OPEN_DL_METU_INVALID_KEYPOINT_VAR),
		        scale_(OPEN_DL_METU_INVALID_KEYPOINT_VAR),
		        orientation_(OPEN_DL_METU_INVALID_KEYPOINT_VAR) {}  	

		Keypoint() : Keypoint(OPEN_DL_METU_INVALID_KEYPOINT_VAR,
                        OPEN_DL_METU_INVALID_KEYPOINT_VAR,
                        Keypoint::INVALID) {}
		~Keypoint() {}
		...
		return strength_ != OPEN_DL_METU_INVALID_KEYPOINT_VAR; }
		...
		inline bool has_scale() const { return scale_ != OPEN_DL_METU_INVALID_KEYPOINT_VAR; }
		...
		return orientation_ != OPEN_DL_METU_INVALID_KEYPOINT_VAR; }
...
#endif // OPEN_DL_METU_FEATURE_KEYPOINT_HPP
